...
DECLARE @Result1 INT = 65 | 11;             -- 65 OR 11
DECLARE @Result2 INT = 65 ^ 11;             -- 65 XOR 11
DECLARE @Result3 INT = 65 & 11;             -- 65 AND 11
DECLARE @Result4 INT = (12 & 4) | (13 & 1);  -- (12 AND 4) OR (13 AND 1)
DECLARE @Result5 INT = 127 | 64;            -- 127 OR 64
DECLARE @Result6 INT = 127 ^ 64;            -- 127 XOR 64
DECLARE @Result7 INT = 127 ^ 128;           -- 127 XOR 128
DECLARE @Result8 INT = 127 & 64;            -- 127 AND 64
DECLARE @Result9 INT = 127 & 128;           -- 127 AND 128

-- Display results in a table
SELECT 
    @Result1 AS [65 OR 11],
    @Result2 AS [65 XOR 11],
    @Result3 AS [65 AND 11],
    @Result4 AS [(12 AND 4) OR (13 AND 1)],
    @Result5 AS [127 OR 64],
    @Result6 AS [127 XOR 64],
    @Result7 AS [127 XOR 128],
    @Result8 AS [127 AND 64],
    @Result9 AS [127 AND 128];
